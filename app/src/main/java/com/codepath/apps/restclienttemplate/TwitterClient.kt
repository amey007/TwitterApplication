...
class TwitterClient(context: Context) : OAuthBaseClient(
    ...
    companion object {
        val REST_API_INSTANCE = TwitterApi.instance()  //Create TwitterApi instance

        const val REST_URL = "https://api.twitter.com/1.1" //Twitter Rest API
    ...
    fun publishTimeline(tweetContent:String, handler: JsonHttpResponseHandler) {
